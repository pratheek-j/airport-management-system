...
var e = {
  ...
  guestSelector: function () {
    if (e.isVariableDefined(e.select(".guest-selector"))) {
      ...
      function showElements() {
        ...
        let guestText = totalAdults > 1 ? "Travelers" : "Traveler";
  ...
  trafficChart: function () {
    ...
    if (e.isVariableDefined(cpv)) {
      const series_d2 = JSON.parse(document.getElementById("data2").textContent);
      // CHART: Page Views
      var options = {
        series: series_d2,
        labels: ["Economy", "Business", "First", "Left"],
        chart: {
          height: 200,
          width: 200,
          offsetX: 0,
  ...
  trafficroomChart: function () {
    const series_d = JSON.parse(document.getElementById("series-data").textContent);
